...
<td>function R = sw_cndr(S,T,P)</td>
</tr><tr><th id="L3"><a href="#L3">3</a></th>
<td></td>
</tr><tr><th id="L4"><a href="#L4">4</a></th>
<td>% SW_CNDR&nbsp; &nbsp; Conductivity ratio&nbsp; &nbsp;R = C(S,T,P)/C(35,15(IPTS-68),0)</td>
</tr><tr><th id="L5"><a href="#L5">5</a></th>
<td>%=========================================================================</td>
</tr><tr><th id="L6"><a href="#L6">6</a></th>
<td>% SW_CNDR&nbsp; $Id: sw_cndr.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Copyright (C) CSIRO, Phil Morgan 1993.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; cndr = sw_cndr(S,T,P)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp;Calculates conductivity ratio from S,T,P.</td>
...
<td>%&nbsp; &nbsp;cndr = Conductivity ratio&nbsp; &nbsp; &nbsp;R =&nbsp; C(S,T,P)/C(35,15(IPTS-68),0) [no units]</td>
...
<td>% CALLEE: sw_salds.m sw_sals.m sw_salrt.m</td>
...
<td>&nbsp; error('sw_cndr.m: must have 3 input arguments')</td>
...
<td><B><span class="code-lang">for</span></B>&nbsp;i = 1:ms</td>
</tr><tr><th id="L82"><a href="#L82">82</a></th>
<td>&nbsp; <B><span class="code-lang">for</span></B> j = 1:ns</td>
</tr><tr><th id="L83"><a href="#L83">83</a></th>
<td>&nbsp; &nbsp; %---------------------------------------------------------------------</td>
</tr><tr><th id="L84"><a href="#L84">84</a></th>
<td>&nbsp; &nbsp; % DO A NEWTON-RAPHSON ITERATION FOR INVERSE INTERPOLATION OF Rt FROM S.</td>
</tr><tr><th id="L85"><a href="#L85">85</a></th>
<td>&nbsp; &nbsp; %---------------------------------------------------------------------</td>
</tr><tr><th id="L86"><a href="#L86">86</a></th>
<td>&nbsp; &nbsp; S_loop&nbsp; = S(i,j);&nbsp; % S <span class="code-type"><B>in</span></B> the loop</td>
</tr><tr><th id="L87"><a href="#L87">87</a></th>
<td>&nbsp; &nbsp; T_loop&nbsp; = T(i,j);&nbsp; % T <span class="code-type"><B>in</span></B> the loop</td>
</tr><tr><th id="L88"><a href="#L88">88</a></th>
<td>&nbsp; &nbsp; Rx_loop = sqrt(S_loop/35.0);&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; % first guess at Rx = sqrt(Rt)</td>
</tr><tr><th id="L89"><a href="#L89">89</a></th>
<td>&nbsp; &nbsp; SInc&nbsp; &nbsp; = sw_sals(Rx_loop.*Rx_loop,T_loop); % S INCrement (guess) from Rx</td>
</tr><tr><th id="L90"><a href="#L90">90</a></th>
<td>&nbsp; &nbsp; iloop&nbsp; &nbsp; = 0;</td>
</tr><tr><th id="L91"><a href="#L91">91</a></th>
<td>&nbsp; &nbsp; end_loop = 0;</td>
</tr><tr><th id="L92"><a href="#L92">92</a></th>
<td>&nbsp; &nbsp; <B><span class="code-lang">while</span></B> ~end_loop</td>
</tr><tr><th id="L93"><a href="#L93">93</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp;Rx_loop = Rx_loop + (S_loop - SInc)./sw_salds(Rx_loop,T_loop - 15);</td>
</tr><tr><th id="L94"><a href="#L94">94</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp;SInc&nbsp; &nbsp; = sw_sals(Rx_loop.*Rx_loop,T_loop);</td>
</tr><tr><th id="L95"><a href="#L95">95</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp;iloop&nbsp; &nbsp;= iloop + 1;</td>
</tr><tr><th id="L96"><a href="#L96">96</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp;dels&nbsp; &nbsp; = abs(SInc-S_loop);</td>
</tr><tr><th id="L97"><a href="#L97">97</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp;<B><span class="code-lang">if</span></B> (dels&gt;1.0e-4 &amp; iloop&lt;10)</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_cndr.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_cndr.m?format=raw">Original Format</a></li></ul></div>
