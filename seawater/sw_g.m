...
<td>% SW_G&nbsp; &nbsp;$Id: sw_g.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; Copyright (C) CSIRO, Phil Morgan 1993.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; g = sw_g(lat,z)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp; Calculates acceleration due to gravity as function of latitude.</td>
...
<td>%&nbsp; &nbsp;z&nbsp; &nbsp;= height <span class="code-type"><B>in</span></B> metres (+ve above sea surface, -ve below)</td>
</tr><tr><th id="L17"><a href="#L17">17</a></th>
<td>%</td>
</tr><tr><th id="L18"><a href="#L18">18</a></th>
<td>% OUTPUT:</td>
</tr><tr><th id="L19"><a href="#L19">19</a></th>
<td>%&nbsp; g&nbsp; &nbsp; = gravity [m/s^2]</td>
</tr><tr><th id="L20"><a href="#L20">20</a></th>
<td>%</td>
</tr><tr><th id="L21"><a href="#L21">21</a></th>
<td>% AUTHOR:&nbsp; Phil Morgan 93-04-20&nbsp; (morgan@<B><span class="code-lang">ml</span></B>.csiro.au)</td>
...
<td><B><span class="code-lang">if</span></B>&nbsp;~(nargin==1 | nargin==2)</td>
</tr><tr><th id="L43"><a href="#L43">43</a></th>
<td>&nbsp; &nbsp;error('sw_g.m:&nbsp; Requires one or two input arguments')</td>
</tr><tr><th id="L44"><a href="#L44">44</a></th>
<td>end %<B><span class="code-lang">if</span></B></td>
</tr><tr><th id="L45"><a href="#L45">45</a></th>
<td><B><span class="code-lang">if</span></B>&nbsp;nargin == 1</td>
</tr><tr><th id="L46"><a href="#L46">46</a></th>
<td>&nbsp; z = zeros(size(LAT));</td>
...
<td><B><span class="code-lang">if</span></B>&nbsp;~(mL==mz | nL==nz)</td>
</tr><tr><th id="L52"><a href="#L52">52</a></th>
<td>&nbsp; &nbsp;error('sw_g.m:&nbsp; Input arguments should have same dimensions')</td>
...
<td>% Eqn p27.&nbsp; Unesco 1983.</td>
</tr><tr><th id="L59"><a href="#L59">59</a></th>
<td>a&nbsp; &nbsp; &nbsp; &nbsp;= 6371000;&nbsp; &nbsp; % mean radius of earth&nbsp; A.E.Gill</td>
...
<td>g&nbsp; &nbsp; &nbsp; &nbsp;= 9.780318*(1.0+(5.2788E-3+2.36E-5*sin2).*sin2);</td>
</tr><tr><th id="L65"><a href="#L65">65</a></th>
<td>if <B><span class="code-func">any</span></B>(any(z))</td>
</tr><tr><th id="L66"><a href="#L66">66</a></th>
<td>&nbsp; &nbsp;g&nbsp; &nbsp; = g./((1+z/a).^2);&nbsp; &nbsp; % from A.E.Gill p.597</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_g.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_g.m?format=raw">Original Format</a></li></ul></div>
