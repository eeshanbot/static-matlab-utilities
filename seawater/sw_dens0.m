...
<td>function dens = sw_dens0(S,T)</td>
...
<td>% SW_DENS0&nbsp; $Id: sw_dens0.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Copyright (C) CSIRO, Phil Morgan 1992</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; dens0 = sw_dens0(S,T)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp; Density of Sea Water at atmospheric pressure using</td>
</tr><tr><th id="L13"><a href="#L13">13</a></th>
<td>%&nbsp; &nbsp; UNESCO 1983 (EOS 1980) polynomial.</td>
...
<td>%&nbsp; &nbsp;dens0 = density&nbsp; [kg/m^3] of salt water with properties S,T,</td>
</tr><tr><th id="L21"><a href="#L21">21</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;P=0 (0 db gauge pressure)</td>
...
<td>% CALLER: general purpose, sw_dens.m</td>
</tr><tr><th id="L42"><a href="#L42">42</a></th>
<td>% CALLEE: sw_smow.m</td>
...
<td>&nbsp; &nbsp;error('sw_dens0.m: Must pass 2 parameters')</td>
...
<td>&nbsp; &nbsp;error('sw_dens0.m: S,T inputs must have the same dimensions')</td>
...
<td>dens = sw_smow(T) + (b0 + (b1 + (b2 + (b3 + b4*T68).*T68).*T68).*T68).*S&nbsp; ...</td>
</tr><tr><th id="L78"><a href="#L78">78</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;+ (c0 + (c1 + c2*T68).*T68).*S.*sqrt(S) + d0*S.^2;</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_dens0.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_dens0.m?format=raw">Original Format</a></li></ul></div>
