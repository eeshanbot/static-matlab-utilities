...
<td>function svan = sw_svan(S,T,P)</td>
...
<td>% SW_SVAN&nbsp; $Id: sw_svan.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Copyright (C) CSIRO,&nbsp; Phil Morgan 1992.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; svan = sw_svan(S,T,P)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp;Specific Volume Anomaly calculated as</td>
</tr><tr><th id="L13"><a href="#L13">13</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; svan = 1/sw_dens(s,t,p) - 1/sw_dens(35,0,p)</td>
</tr><tr><th id="L14"><a href="#L14">14</a></th>
<td>%&nbsp; &nbsp;Note that it is often quoted <span class="code-type"><B>in</span></B> literature as 1e8*units</td>
...
<td>%&nbsp; svan = Specific Volume Anomaly&nbsp; [m^3 kg^-1]</td>
...
<td>%&nbsp; &nbsp; &nbsp;Fofonoff, N.P. and Millard, R.C. Jr</td>
...
<td>&nbsp; &nbsp;error('sw_svan.m: Must pass 3 parameters')</td>
...
<td>svan = (&nbsp; ones(size(S)) ./ sw_dens(S,T,P)) - ...</td>
</tr><tr><th id="L87"><a href="#L87">87</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;(ones(size(S)) ./ sw_dens(35*ones(size(S)),zeros(size(S)),P) );</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_svan.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_svan.m?format=raw">Original Format</a></li></ul></div>
