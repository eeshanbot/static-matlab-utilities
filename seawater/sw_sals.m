...
<td>% SW_SALS&nbsp; $Id: sw_sals.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Copyright (C) CSIRO, Phil Morgan 1993.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; S = sw_sals(Rt,T)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp; Salinity of sea water as a function of Rt and T.</td>
...
<td>%&nbsp; &nbsp;Rt = Rt(S,T) = C(S,T,0)/C(35,T(IPTS-68),0)</td>
...
<td>&nbsp; error('sw_sals.m: requires 2 input arguments')</td>
...
<td>[mrt,nrt] = size(Rt);</td>
</tr><tr><th id="L48"><a href="#L48">48</a></th>
<td>[mT,nT]&nbsp; &nbsp;= size(T);</td>
</tr><tr><th id="L49"><a href="#L49">49</a></th>
<td><B><span class="code-lang">if</span></B>&nbsp;~(mrt==mT | nrt==nT)</td>
</tr><tr><th id="L50"><a href="#L50">50</a></th>
<td>&nbsp; &nbsp;error('sw_sals.m: Rt and T must have the same shape')</td>
...
<td>del_S = (del_T68 ./ (1+k*del_T68) ) .* ...</td>
</tr><tr><th id="L77"><a href="#L77">77</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; ( b0 + (b1 + (b2+ (b3 + (b4 + b5.*Rtx).*Rtx).*Rtx).*Rtx).*Rtx);</td>
</tr><tr><th id="L78"><a href="#L78">78</a></th>
<td></td>
</tr><tr><th id="L79"><a href="#L79">79</a></th>
<td>S = a0 + (a1 + (a2 + (a3 + (a4 + a5.*Rtx).*Rtx).*Rtx).*Rtx).*Rtx;</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_sals.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_sals.m?format=raw">Original Format</a></li></ul></div>
