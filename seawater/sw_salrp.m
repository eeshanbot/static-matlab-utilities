...
<td>function Rp = sw_salrp(R,T,P)</td>
...
<td>% SW_SALRP&nbsp; &nbsp;$Id: sw_salrp.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Copyright (C) CSIRO, Phil Morgan 1993.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; Rp = sw_salrp(R,T,P)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp; Equation Rp(S,T,P) = C(S,T,P)/C(S,T,0) used <span class="code-type"><B>in</span></B> calculating salinity.</td>
</tr><tr><th id="L13"><a href="#L13">13</a></th>
<td>%&nbsp; &nbsp; UNESCO 1983 polynomial.</td>
</tr><tr><th id="L14"><a href="#L14">14</a></th>
<td>%</td>
</tr><tr><th id="L15"><a href="#L15">15</a></th>
<td>% INPUT: (All must have same shape)</td>
</tr><tr><th id="L16"><a href="#L16">16</a></th>
<td>%&nbsp; &nbsp;R = Conductivity ratio&nbsp; R =&nbsp; C(S,T,P)/C(35,15(IPTS-68),0) [no units]</td>
...
<td>%&nbsp; &nbsp;Rp = conductivity ratio&nbsp; Rp(S,T,P) = C(S,T,P)/C(S,T,0)&nbsp; [no units]</td>
...
<td>&nbsp; error('sw_salrp.m: requires 3 input arguments')</td>
...
<td><B><span class="code-lang">if</span></B>&nbsp;~(mr==mp | mr==mt | nr==np | nr==nt)</td>
</tr><tr><th id="L52"><a href="#L52">52</a></th>
<td>&nbsp; &nbsp;error('sw_salrp.m: R,T,P must all have the same shape')</td>
...
<td>Rp = 1 + ( P.*(e1 + e2.*P + e3.*P.^2) ) ...</td>
</tr><tr><th id="L71"><a href="#L71">71</a></th>
<td>&nbsp; &nbsp; &nbsp;./ (1 + d1.*T68 + d2.*T68.^2 +(d3 + d4.*T68).*R);</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_salrp.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_salrp.m?format=raw">Original Format</a></li></ul></div>
