...
<td>function [BETA] = sw_beta(S, T, P, keyword)</td>
...
<td>% SW_BETA&nbsp; $Id: sw_beta.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp;%&nbsp; &nbsp; &nbsp; Copyright (C) CSIRO, Nathan Bindoff 1993.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; [BETA] = sw_beta(S, T, P, {keyword} )</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;[BETA] = sw_beta(S, T,&nbsp; &nbsp; P, 'temp')&nbsp; &nbsp; &nbsp;%<B><span class="code-lang">default</span></B></td>
...
<td>%&nbsp; &nbsp;The saline contraction coefficient as defined by T.J. McDougall.</td>
...
<td>% * PTMP&nbsp; &nbsp; = potential temperature [degree C (ITS-90)]</td>
...
<td>%&nbsp; &nbsp;keyword = optional string to identify <B><span class="code-lang">if</span></B> temp or ptmp passed.</td>
</tr><tr><th id="L25"><a href="#L25">25</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;= No argument defaults to 'temp'</td>
</tr><tr><th id="L26"><a href="#L26">26</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;= 'temp' assumes (S,T,P) passed.&nbsp; &nbsp; Will execute slower</td>
</tr><tr><th id="L27"><a href="#L27">27</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; as ptmp will be calculated internally.</td>
</tr><tr><th id="L28"><a href="#L28">28</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;= 'ptmp' assumes (S,PTMP,P) passed. Will execute faster.</td>
</tr><tr><th id="L29"><a href="#L29">29</a></th>
<td>%</td>
</tr><tr><th id="L30"><a href="#L30">30</a></th>
<td>% OUTPUT</td>
</tr><tr><th id="L31"><a href="#L31">31</a></th>
<td>%&nbsp; &nbsp;BETA = Saline Contraction Coefficient&nbsp; [psu.^-1]</td>
</tr><tr><th id="L32"><a href="#L32">32</a></th>
<td>%</td>
</tr><tr><th id="L33"><a href="#L33">33</a></th>
<td>% AUTHOR:&nbsp; &nbsp;N.L. Bindoff&nbsp; 1993, Lindsay Pender (Lindsay.pender@<B><span class="code-lang">csiro</span></B>.au)</td>
...
<td>%&nbsp; &nbsp; McDougall, T.J. 1987. <span class="code-string"><B>&quot;Neutral Surfaces&quot;</span></B></td>
</tr><tr><th id="L41"><a href="#L41">41</a></th>
<td>%&nbsp; &nbsp; Journal of Physical Oceanography vol 17 pages 1950-1964,</td>
</tr><tr><th id="L42"><a href="#L42">42</a></th>
<td>%</td>
</tr><tr><th id="L43"><a href="#L43">43</a></th>
<td>% CHECK VALUE:</td>
</tr><tr><th id="L44"><a href="#L44">44</a></th>
<td>%&nbsp; &nbsp; beta=0.72088e-3 psu.^-1 at S=40.0 psu, ptmp = 10.0 C (ITS-68), p=4000 db</td>
...
<td>% 93-04-22. Phil Morgan,&nbsp; Help display modified to suit library</td>
</tr><tr><th id="L49"><a href="#L49">49</a></th>
<td>% 93-04-23. Phil Morgan,&nbsp; Input argument checking</td>
</tr><tr><th id="L50"><a href="#L50">50</a></th>
<td>% 94-10-15. Phil Morgan,&nbsp; Pass S,T,P and keyword <B><span class="code-lang">for</span></B> 'ptmp'</td>
...
<td><B><span class="code-lang">if</span></B>&nbsp;~(nargin==3 | nargin==4)</td>
</tr><tr><th id="L56"><a href="#L56">56</a></th>
<td>&nbsp; error('sw_beta.m: requires 3 or 4 input arguments')</td>
...
<td>% ENSURE WE USE PTMP IN CALCULATIONS</td>
</tr><tr><th id="L89"><a href="#L89">89</a></th>
<td><B><span class="code-lang">if</span></B>&nbsp;~strcmp(lower(keyword),'ptmp')</td>
</tr><tr><th id="L90"><a href="#L90">90</a></th>
<td>&nbsp; T = sw_ptmp(S,T,P,0); % now have ptmp</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_beta.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_beta.m?format=raw">Original Format</a></li></ul></div>
