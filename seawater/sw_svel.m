...
<td>function svel = sw_svel(S,T,P)</td>
...
<td>% SW_SVEL&nbsp; $Id: sw_svel.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Copyright (C) CSIRO, Phil Morgan 1993.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; svel = sw_svel(S,T,P)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp; Sound Velocity <span class="code-type"><B>in</span></B> sea water using UNESCO 1983 polynomial.</td>
...
<td>%&nbsp; &nbsp;svel = sound velocity&nbsp; [m/s]</td>
</tr><tr><th id="L22"><a href="#L22">22</a></th>
<td>%</td>
</tr><tr><th id="L23"><a href="#L23">23</a></th>
<td>% AUTHOR:&nbsp; Phil Morgan 93-04-20, Lindsay Pender (Lindsay.Pender@<B><span class="code-lang">csiro</span></B>.au)</td>
...
<td>&nbsp; &nbsp;error('sw_svel.m: Must pass 3 parameters')</td>
...
<td>P = P/10;&nbsp; % convert db to bars as used <span class="code-type"><B>in</span></B> UNESCO routines</td>
...
<td>A = ((((a32.*T68 + a31).*T68 + a30).*P + ...</td>
</tr><tr><th id="L140"><a href="#L140">140</a></th>
<td>&nbsp; &nbsp; (((a23.*T68 + a22).*T68 + a21).*T68 + a20)).*P + ...</td>
</tr><tr><th id="L141"><a href="#L141">141</a></th>
<td>&nbsp; &nbsp; ((((a14.*T68 + a13).*T68 + a12).*T68 + a11).*T68 + a10)).*P + ...</td>
</tr><tr><th id="L142"><a href="#L142">142</a></th>
<td>&nbsp; &nbsp; (((a04.*T68 + a03).*T68 + a02).*T68 + a01).*T68 + a00;</td>
...
<td>B = b00 + b01.*T68 + (b10 + b11.*T68).*P;</td>
...
<td>svel = Cw + A.*S + B.*S.*sqrt(S) + D.*S.^2;</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_svel.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_svel.m?format=raw">Original Format</a></li></ul></div>
