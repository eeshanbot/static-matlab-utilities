...
<td>function PT = sw_ptmp(S,T,P,PR)</td>
...
<td>% SW_PTMP&nbsp; $Id: sw_ptmp.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Copyright (C) CSIRO, Phil Morgan 1992.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE:&nbsp; ptmp = sw_ptmp(S,T,P,PR)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp; Calculates potential temperature as per UNESCO 1983 report.</td>
...
<td>%&nbsp; &nbsp;PR = Reference pressure&nbsp; [db]</td>
</tr><tr><th id="L19"><a href="#L19">19</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; (P &amp; PR may have dims 1x1, mx1, 1xn or mxn <B><span class="code-lang">for</span></B> S(mxn) )</td>
</tr><tr><th id="L20"><a href="#L20">20</a></th>
<td>%</td>
</tr><tr><th id="L21"><a href="#L21">21</a></th>
<td>% OUTPUT:</td>
</tr><tr><th id="L22"><a href="#L22">22</a></th>
<td>%&nbsp; &nbsp;ptmp = Potential temperature relative to PR [degree C (ITS-90)]</td>
</tr><tr><th id="L23"><a href="#L23">23</a></th>
<td>%</td>
</tr><tr><th id="L24"><a href="#L24">24</a></th>
<td>% AUTHOR:&nbsp; Phil Morgan 92-04-06, Lindsay Pender (Lindsay.Pender@<B><span class="code-lang">csiro</span></B>.au)</td>
...
<td>%&nbsp; &nbsp; <span class="code-string"><B>&quot;New Polynomials for thermal expansion, adiabatic temperature gradient</span></td>
</tr><tr><th id="L38"><a href="#L38">38</a></th>
<td><span class="code-string">%&nbsp; &nbsp; and potential temperature of sea water.&quot;</span></B></td>
</tr><tr><th id="L39"><a href="#L39">39</a></th>
<td>%&nbsp; &nbsp; DEEP-SEA RES., 1973, Vol20,401-408.</td>
...
<td><B><span class="code-lang">if</span></B>&nbsp;nargin ~= 4</td>
</tr><tr><th id="L53"><a href="#L53">53</a></th>
<td>&nbsp; &nbsp;error('sw_ptmp.m: Must pass 4 parameters ')</td>
...
<td>% CHECK OPTIONAL SHAPES FOR PR</td>
</tr><tr><th id="L85"><a href="#L85">85</a></th>
<td><B><span class="code-lang">if</span></B>&nbsp;&nbsp; &nbsp; mpr==1&nbsp; &amp; npr==1&nbsp; &nbsp; &nbsp; % PR is a scalar.&nbsp; Fill to size of S</td>
</tr><tr><th id="L86"><a href="#L86">86</a></th>
<td>&nbsp; &nbsp;PR = PR(1)*ones(ms,ns);</td>
</tr><tr><th id="L87"><a href="#L87">87</a></th>
<td>elseif npr==ns &amp; mpr==1&nbsp; &nbsp; &nbsp; % PR is row vector with same cols as S</td>
</tr><tr><th id="L88"><a href="#L88">88</a></th>
<td>&nbsp; &nbsp;PR = PR( ones(1,ms), : ); %&nbsp; &nbsp;Copy down each column.</td>
</tr><tr><th id="L89"><a href="#L89">89</a></th>
<td>elseif mpr==ms &amp; npr==1&nbsp; &nbsp; &nbsp; % P is column vector</td>
</tr><tr><th id="L90"><a href="#L90">90</a></th>
<td>&nbsp; &nbsp;PR = PR( :, ones(1,ns) ); %&nbsp; &nbsp;Copy across each row</td>
</tr><tr><th id="L91"><a href="#L91">91</a></th>
<td>elseif mpr==ms &amp; npr==ns&nbsp; &nbsp; &nbsp;% PR is a matrix size(S)</td>
</tr><tr><th id="L92"><a href="#L92">92</a></th>
<td>&nbsp; &nbsp;% shape ok</td>
</tr><tr><th id="L93"><a href="#L93">93</a></th>
<td><B><span class="code-lang">else</span></B></td>
</tr><tr><th id="L94"><a href="#L94">94</a></th>
<td>&nbsp; error('check_stp: PR has wrong dimensions')</td>
...
<td>del_th = del_P.*sw_adtg(S,T,P);</td>
</tr><tr><th id="L106"><a href="#L106">106</a></th>
<td>th&nbsp; &nbsp; &nbsp;= T * 1.00024 + 0.5*del_th;</td>
...
<td>del_th = del_P.*sw_adtg(S,th/1.00024,P+0.5*del_P);</td>
</tr><tr><th id="L111"><a href="#L111">111</a></th>
<td>th&nbsp; &nbsp; &nbsp;= th + (1 - 1/sqrt(2))*(del_th - q);</td>
</tr><tr><th id="L112"><a href="#L112">112</a></th>
<td>q&nbsp; &nbsp; &nbsp; = (2-sqrt(2))*del_th + (-2+3/sqrt(2))*q;</td>
...
<td>del_th = del_P.*sw_adtg(S,th/1.00024,P+del_P);</td>
</tr><tr><th id="L121"><a href="#L121">121</a></th>
<td>PT&nbsp; &nbsp; &nbsp;= (th + (del_th - 2*q)/6)/1.00024;</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_ptmp.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_ptmp.m?format=raw">Original Format</a></li></ul></div>
