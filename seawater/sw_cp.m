...
<td>% SW_CP&nbsp; $Id: sw_cp.m,v 1.1 2003/12/12 04:23:22 pen078 Exp $</td>
</tr><tr><th id="L7"><a href="#L7">7</a></th>
<td>%&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Copyright (C) CSIRO, Phil Morgan 1993.</td>
</tr><tr><th id="L8"><a href="#L8">8</a></th>
<td>%</td>
</tr><tr><th id="L9"><a href="#L9">9</a></th>
<td>% USAGE: cp = sw_cp(S,T,P)</td>
</tr><tr><th id="L10"><a href="#L10">10</a></th>
<td>%</td>
</tr><tr><th id="L11"><a href="#L11">11</a></th>
<td>% DESCRIPTION:</td>
</tr><tr><th id="L12"><a href="#L12">12</a></th>
<td>%&nbsp; &nbsp; Heat Capacity of Sea Water using UNESCO 1983 polynomial.</td>
...
<td>%&nbsp; &nbsp;cp = Specific Heat Capacity&nbsp; [J kg^-1 C^-1]</td>
...
<td>%&nbsp; &nbsp; Fofonff, P. and Millard, R.C. Jr</td>
...
<td>&nbsp; &nbsp;error('Must pass 3 parameters')</td>
...
<td>&nbsp; &nbsp;error('P has wrong dimensions')</td>
...
<td>P = P/10; % to convert db to Bar as used <span class="code-type"><B>in</span></B> Unesco routines</td>
...
<td>c3 =&nbsp; &nbsp;-2.654387e-3;</td>
</tr><tr><th id="L88"><a href="#L88">88</a></th>
<td>c4 =&nbsp; &nbsp; 2.093236e-5;</td>
...
<td>Cpst0 = (((c4.*T68 + c3).*T68 + c2).*T68 + c1).*T68 + c0 + ...</td>
</tr><tr><th id="L99"><a href="#L99">99</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; (a0 + a1.*T68 + a2.*T68.^2).*S + ...</td>
</tr><tr><th id="L100"><a href="#L100">100</a></th>
<td>&nbsp; &nbsp; (b0 + b1.*T68 + b2.*T68.^2).*S.*sqrt(S);</td>
...
<td>del_Cp0t0 =&nbsp; (((((c3.*T68 + c2).*T68 + c1).*T68 + c0).*P + ...</td>
</tr><tr><th id="L123"><a href="#L123">123</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;((((b4.*T68 + b3).*T68 + b2).*T68 + b1).*T68 + b0)).*P + ...</td>
</tr><tr><th id="L124"><a href="#L124">124</a></th>
<td>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;((((a4.*T68 + a3).*T68 + a2).*T68 + a1).*T68 + a0)).*P;</td>
...
<div id="altlinks"><h3>Download in other formats:</h3><ul><li class="first"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_cp.m?format=txt">Plain Text</a></li><li class="last"><a href="/dataproc/browser/gliderproc/trunk/MATLAB/seawater/sw_cp.m?format=raw">Original Format</a></li></ul></div>
