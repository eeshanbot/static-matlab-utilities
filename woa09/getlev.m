...
%
% Uses "getdist.m", which uses WGS84 ellipsoid by default, and
...
%
%
% glat,glon are a single point, or points along a path, perhaps found by getdist.m
...
dataBaseDir='/home/eesh/Documents/MATLAB/woa09/';
%
...
for k=1:length(glon),
       rtmp = [rtmp getdist( [lats glat(k)], [lons glon(k)] ) ];
end
